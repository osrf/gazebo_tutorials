...
1. Download the following dependencies into that directory:
    ...
    1. [OGRE 1.9.0 snapshot 12.03.2016](http://packages.osrfoundation.org/win32/deps/OGRE-SDK-1.9.0-vc120-x64-12.03.2016.zip)

    1. [protobuf 2.6.0](http://packages.osrfoundation.org/win32/deps/protobuf-2.6.0-cmake3.5-win64-vc12.zip)
...
1. Install the package manager "chocolatey" as indicated in the [install page](https://chocolatey.org/install)

1. Use chocalatey to install the system dependencies:

    > choco install -y cmake git ruby qt4 hg
