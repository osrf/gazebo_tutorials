...
<include from='/  std::string simTime/' to='/  \/\/ The variables to watch are registered with the manager/' src="http://bitbucket.org/osrf/gazebo_tutorials/raw/default/introspection/files/watcher.cc"/>
