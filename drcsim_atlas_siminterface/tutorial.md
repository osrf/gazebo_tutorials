...
<include from='@class AtlasWalk():@' to='@print("Shutting down")@' src='http://bitbucket.org/osrf/gazebo_tutorials/raw/default/drcsim_atlas_siminterface/files/walk.py' />
...
<include from='/36/' to='/45/' src='http://bitbucket.org/osrf/gazebo_tutorials/raw/default/drcsim_atlas_siminterface/files/walk.py' />
...
<include from='@.*# /atlas/atlas_state callback.*@' to='@.*roll, pitch, yaw =.*' src='http://bitbucket.org/osrf/gazebo_tutorials/raw/default/drcsim_atlas_siminterface/files/walk.py' />
