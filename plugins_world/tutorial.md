...
<include from="/#include/" to="/_sdf\*\/\)/" src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/factory.cc' />
...
<include from="/    \/\/ Option 1:/" to="/\/\/box"\);/" src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/factory.cc' />

The second method uses a World method to load a model based on string data.

<include from="/    \/\/ Option 2:/" to="/sphereSDF\);/" src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/factory.cc' />
...
<include from="/    \/\/ Option 3:!" to="/factoryPub.*Publish\(msg\);/" src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/factory.cc' />
...
<include from="/add_library/" src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/CMakeLists.txt' />
...
<include src='http://bitbucket.org/osrf/gazebo/raw/gazebo8/examples/plugins/factory/factory.world' />
