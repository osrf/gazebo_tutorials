...
1.  In Gazebo, drag the `My Robot` model in the world. The visual for the chassis will look like a pioneer2dx.
    ...
    <img src="http://bitbucket.org/osrf/gazebo_tutorials/raw/default/attach_meshes/Mobile_robot_chassis_1.png" width="640px"/>
...
1.  Modify the visual to have a scaling factor.
    ...
    <img src="http://bitbucket.org/osrf/gazebo_tutorials/raw/default/attach_meshes/Mobile_robot_chassis_2.png" width="640px"/>
...
1.  The visual is also a little too low (along the z-axis). Let's raise it up a little by specifying a pose for the visual:
    ...
    <img src="http://bitbucket.org/osrf/gazebo_tutorials/raw/default/attach_meshes/Mobile_robot_chassis_3.png" width="640px"/>
