...
If you received a premade set of tracking targets, download the Motive project file, [haptix_osrf.ttp](https://github.com/osrf/gazebo_tutorials/raw/default/haptix_optitrack/files/haptix_osrf.ttp) to the Desktop of the Windows machine. We are going to make a small modification to calibrate each component.
...
Now, select "File", "Open", and select the project file you downloaded, [haptix_osrf.ttp](https://github.com/osrf/gazebo_tutorials/raw/default/haptix_optitrack/files/haptix_osrf.ttp).
