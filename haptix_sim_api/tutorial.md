...
[here](https://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m)
...
<include lang='matlab' from="/% Get the user camera pose/" to="/hxs_set_camera_transform\(new_tx\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/% Change the table color./" to="/hxs_model_color\('table'\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/% Get contact information/" to="/hxs_contacts\('wood_cube_5cm'\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/% Move by setting linear velocity/" to="/\[-0.5; 0; 0\]\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/% Move by setting angular velocity/" to="/, \[0; 0; 100\]\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/% Apply force and torque at the same time./" to="/wrench, 0.1\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Check gravity mode on wooden cube/" to="/hxs_set_model_gravity_mode\('wood_cube_5cm', gravity_mode\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Get the pose of the cube/" to="/hxs_set_model_transform\('wood_cube_5cm', tx\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Set the position of the arm/" to="/arm_tx\)/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Check collide mode on the cube/" to="/hxs_set_model_collide_mode\('wood_cube_5cm', collide_mode\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Define a new model./" to="/hxs_remove_model\('green_cricket_ball'\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Set the state of a wrist joint/" to="/'wristy', 0.5, 0.0\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
...
<include lang='matlab' from="/\% Move the camera/" to="/hxs_reset\(1\);/" src='http://github.com/osrf/haptix-comm/raw/default/matlab/hxs_example.m'/>
