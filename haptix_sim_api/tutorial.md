...
<include lang='matlab' from="/% Get contact information/" to="/contacts\(contact_idx\).distance);\nend/" src='http://bitbucket.org/osrf/haptix-comm/raw/update_hxs_example/matlab/hxs_example.m'/> 
