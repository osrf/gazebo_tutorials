...
SDFormat and Gazebo-classic depend on the ignition math library.
...
Gazebo-classic depends on the SDFormat package. Let's build it, then build Gazebo-classic off of that:
