...
Copy the world code and save it as `joint_event.world` (or download it from [here](https://github.com/osrf/gazebo_tutorials/raw/default/joint_events/joint_event.world)):

<include lang="sdf" src='https://github.com/osrf/gazebo_tutorials/raw/default/joint_events/joint_event.world' />
