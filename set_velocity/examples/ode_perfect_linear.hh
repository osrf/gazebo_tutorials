...
class PerfectLinearVelController
{
  public: PerfectLinearVelController()
    {
    }
  ...
  public: void Start(
    ...
    {
      this->Stop();
      // create prismatic joint with parent "world" and child _link
...
PerfectLinearVelController controller;
...
// ...
// Wait at least one time step before stopping the controller or no force will
// be applied!
controller.Stop();
