...
1. For this exercise, modify `~/.gazebo/models/my_robot/model.sdf` to make the model larger so it can accommodate the gripper we are about to append to it:
    ...
    <include src='https://github.com/osrf/gazebo_tutorials/raw/default/attach_gripper/files/model-1.9+.sdf' />
...
1. To create a mobile robot with a simple gripper attached, create a new models directory
    ...
    <include src='https://github.com/osrf/gazebo_tutorials/raw/default/attach_gripper/files/model-1.9+.config' />
...
1. Next, create the model SDF file:
    ...
    <include src='https://github.com/osrf/gazebo_tutorials/raw/default/attach_gripper/files/manipulator-1.9+.sdf' />
