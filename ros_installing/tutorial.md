...
The set of ROS packages for interfacing with Gazebo are contained within a new meta package (catkin's version of stacks) named <tt>gazebo_ros_pkgs</tt>. See [Overview of new ROS integration](Tutorials/1.9/Overview of new ROS integration) for background information before continuing here.
