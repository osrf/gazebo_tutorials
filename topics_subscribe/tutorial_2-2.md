...
mkdir ~/listener
cd ~/listener
wget https://github.com/osrf/gazebo/raw/gazebo_2.2/examples/stand_alone/listener/listener.cc
wget https://github.com/osrf/gazebo/raw/gazebo_2.2/examples/stand_alone/listener/CMakeLists.txt
mkdir build
cd build
cmake ..
make
