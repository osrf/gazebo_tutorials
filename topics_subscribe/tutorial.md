...
mkdir ~/listener
cd ~/listener
wget https://github.com/osrf/gazebo/raw/default/examples/stand_alone/listener/listener.cc
wget https://github.com/osrf/gazebo/raw/default/examples/stand_alone/listener/CMakeLists.txt
mkdir build
cd build
cmake ..
make
